...
export const Sidebar = () => {
  ...
  return (
    <div className='flex-none flex-column h-screen w-2/12 justify-evenly pl-10 my-10 gap-10'>
        ...
        <p className='my-12 w-fit p-2 rounded-lg lato-regular lato-regular hover:bg-indigo-300 cursor-pointer'><FontAwesomeIcon icon={faUser} style={{fontSize:"24px"}} onClick={navigate`/ConnectApp/Profile`}/> &nbsp;&nbsp; Profile </p>
